...
func TestApplyEnsuresMonitoredDB(t *testing.T) {
	...
	mock.ExpectQuery(regexp.QuoteMeta(scanSQL)).
		WillReturnRows(sqlmock.NewRows([]string{"db_id", "table_name", "column_name", "data_type", "label_key", "widget", "placeholder_key", "nullable", "unique", "has_default", "default_value", "validator"}))
