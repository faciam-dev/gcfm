...
- [type UnsupportedDialect](<#UnsupportedDialect>)
  - [func \(UnsupportedDialect\) Placeholder\(int\) string](<#UnsupportedDialect.Placeholder>)
  - [func \(UnsupportedDialect\) QuoteIdent\(ident string\) string](<#UnsupportedDialect.QuoteIdent>)
...
<a name="UnsupportedDialect"></a>
## type UnsupportedDialect

UnsupportedDialect is returned when a driver has no corresponding goquent dialect. It satisfies the ormdriver.Dialect interface with no\-op implementations.
...
<a name="UnsupportedDialect.Placeholder"></a>
### func \(UnsupportedDialect\) Placeholder

```go
func (UnsupportedDialect) Placeholder(int) string
```



<a name="UnsupportedDialect.QuoteIdent"></a>
### func \(UnsupportedDialect\) QuoteIdent

```go
func (UnsupportedDialect) QuoteIdent(ident string) string
```
